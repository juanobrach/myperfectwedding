...
function et_builder_load_modules_styles() {
	...
	wp_register_script( 'google-maps-api', esc_url( add_query_arg( array( 'v' => 3, 'sensor' => 'false' ), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js?key=AIzaSyBjrlTATwBEloUDqKxMRlT8emyDJtHwB2M' : 'http://maps.google.com/maps/api/js?key=AIzaSyBjrlTATwBEloUDqKxMRlT8emyDJtHwB2M') ), array(), ET_BUILDER_VERSION, true );
